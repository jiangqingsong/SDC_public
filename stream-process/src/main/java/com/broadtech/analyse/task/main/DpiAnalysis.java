...
public class DpiAnalysis {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //sink
        ccAbnormalBatchStream.addSink(new AlarmResultSink(jdbcUrl, userName, password, producerBrokers, sendTopic));
        ccAbnormal2BatchStream.addSink(new AlarmResultSink(jdbcUrl, userName, password, producerBrokers, sendTopic));
        suspiciousOutBatchStream.addSink(new AlarmResultSink(jdbcUrl, userName, password, producerBrokers, sendTopic));
        scanBatchStream.addSink(new AlarmResultSink(jdbcUrl, userName, password, producerBrokers, sendTopic));
        intranetFallBatchStream.addSink(new AlarmResultSink(jdbcUrl, userName, password, producerBrokers, sendTopic));
