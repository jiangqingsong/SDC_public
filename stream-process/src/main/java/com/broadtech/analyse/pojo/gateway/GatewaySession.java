...
public class GatewaySession {
    ...
    private String appServerMac;
    private String appServerPort;
    private String appType;
    private String appSubType;
    private Double ulData;
    private Double dlData;
    private String rule;
    ...
    public String getAppServerMac() {
        return appServerMac;
    }

    public void setAppServerMac(String appServerMac) {
        this.appServerMac = appServerMac;
    }
    ...
    public Double getUlData() {
        return ulData;
    }

    public void setUlData(Double ulData) {
        this.ulData = ulData;
    }

    public Double getDlData() {
        return dlData;
    }

    public void setDlData(Double dlData) {
        this.dlData = dlData;
    }
    ...
    public String getAppSatus() {
        return appSatus;
    }

    public void setAppSatus(String appSatus) {
        this.appSatus = appSatus;
    }
